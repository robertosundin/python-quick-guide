...
Oftentimes we search to create arrays containing certain type of elements.
...
print(a)
```	
or we could use another feature of list comprehensions called _filtering_
...
where an if-statement has been added at the end.
